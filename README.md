...
### Integrated Console (v0.6.0)

- **Console** opens an integrated VM console tab inside HyperGery for VNC-backed running VMs.
...
- The console tab warns that closing/disconnecting the console does not stop the VM; use ACPI Shutdown or Force Off to stop it.
- SPICE remains supported for external viewing. For the first integrated console implementation, choose display mode `vnc` when creating or editing a VM.
